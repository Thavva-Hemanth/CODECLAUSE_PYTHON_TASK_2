...
def addsongs():
    ...
    for s in temp_song:
        s = s.replace("C:/Users/HEMANTH/Desktop/mp3/Music/", "")
...
def Play():
    ...
    song = f'C:/Users/HEMANTH/Desktop/mp3/Music/{song}'
...
def Previous():
    ...
    temp2 = f'C:/Users/HEMANTH/Desktop/mp3/Music/{temp2}'
...
def Next():
    ...
    temp = f'C:/Users/HEMANTH/Desktop/mp3/Music/{temp}'
...
root=Tk()
root.title('Hemanth Music player App ')
#initialize mixer 
mixer.init()
